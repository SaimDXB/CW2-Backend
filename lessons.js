...
let app = new Vue({
    ...
    data: {
        ...
        sortOrder: '',
        searchQuery: '',
        awsURL: 'http://ed21test-env.eba-f3k3idms.eu-west-2.elasticbeanstalk.com', // AWS Elastic Beanstalk URL
        localhostURL: 'http://localhost:3000', // Localhost URL
        useAWS: false, // Flag to indicate whether to use AWS URL or localhost URL
    },
    computed: {
        baseURL: function () {
            return this.useAWS ? this.awsURL : this.localhostURL;
        },
    ...
    methods: {
        ...
        placeOrder: function () {
            if (this.isOrderValid) {
                fetch(`${this.baseURL}/api/orders/place`, {
                    method: 'POST',
                    headers: {
